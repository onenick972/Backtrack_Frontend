...
import {
  Box, Stack, Typography, TextField, Button, Divider, Grid,
} from '@mui/material';
      ...
      >
        <Box>
          <Stack
            ...
            <Box>
              <Typography sx={{ fontFamily: '"Fraunces", serif', fontSize: '1.875rem', fontWeight: 600, lineHeight: 1, letterSpacing: '-0.01em' }}>
                BackPocket
              </Typography>
              <Typography sx={{
                ...
                Francis Financial & Business Consultancy
              </Typography>
            </Box>
          </Stack>
        </Box>
        ...
        <Stack spacing={3} sx={{ maxWidth: 480 }}>
          <Typography sx={{
            ...
            Every figure,{' '}
            <Box component="span" sx={{ fontStyle: 'italic', color: colors.accent.main }}>
              accounted for.
            </Box>
          </Typography>
          <Typography sx={{ color: colors.ink[400], lineHeight: 1.6 }}>
            Tailored billing and financial management for the businesses we serve —
            customer ledgers, project tracking, invoice generation, and MMG and bank
        ...
        <Typography sx={{
          ...
          {new Date().getFullYear()} — Powered by ASP.NET Core & React
        </Typography>
      </Box>
      {/* Right: form */}
      <Box sx={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', p: 4 }}>
        <Box sx={{ width: '100%', maxWidth: 360 }}>
          <Box sx={{ display: { xs: 'flex', md: 'none' }, alignItems: 'center', gap: 1.5, mb: 4 }}>
            <Box component="img" src="/logo.png" sx={{ width: 40, height: 40, objectFit: 'contain' }} />
            <Box>
